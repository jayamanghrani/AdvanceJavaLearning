...
6. declare static variable----No, because scriplet ka code method ke andr jata h , static var class level pe bnte h 
							method ke andr nhi.
7. define method---No
8. can write html---No ,then how can we generate html output from scriplet , 
					because browser to sirf html smjhta h 	

				Solution -- By predefine object called out.
				out.println(<p>Hello</p>);		
			ye out jspWriter ka obj h ,
			 jab ye code method ke andr jayega to PrintWriter ke andr chla jayega.
			 	b/c jspwriter is child class of printWriter
