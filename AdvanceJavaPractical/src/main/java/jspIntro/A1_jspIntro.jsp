...
If we create jsp using notepad/inside tomcat folder
path -- C:\Program Files\Apache Software Foundation\Tomcat 8.5\work\Catalina\localhost\datetimejsp\org\apache\jsp
