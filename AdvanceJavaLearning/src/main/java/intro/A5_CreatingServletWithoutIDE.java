...
{
  resp.setContentType() //recommended- we are informing browser that resp is in html form, morden browser know this ,but this is for old browser 



		// ServletResponse  obj having a  buffer, we have to copy our content in buffer.beacuse servletContainer buffer se data lekr browser ko deta h
...
/** Step2 */
/* save it on any location and compile the code */

/*filename-"MyFirstServlet.java"
location-D:\My Eclipse Workspace\JakartaEEServlets*/


/*
 * compile-
 * 
 * D:\My Eclipse Workspace\JakartaEEServlets---javac 
 * 
